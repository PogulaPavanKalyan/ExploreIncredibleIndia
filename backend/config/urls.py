...
urlpatterns = [
    ...
    path('api/collections/', include('apps.destinations.collection_urls')),
    ...
    path('api/stories/', include('apps.travel_guides.urls')),
    ...
    path('api/trips/', include('apps.travel_planner.urls')),
